...
const AddAccount = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post('https://final-project-sepia-sigma.vercel.app/addaccount', accountData,
                {
            ...
            const res2 = await axios.post('https://final-project-sepia-sigma.vercel.app/addprofile', profileData,
                {
                    headers: {'Content-Type': 'application/json'},
                });
