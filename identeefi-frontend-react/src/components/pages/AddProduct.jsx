...
const AddProduct = () => {    
    ...
    const uploadImage = async (image) => {
        ...
        axios.post("https://final-project-sepia-sigma.vercel.app/upload/product", data, {
    ...
    const addProductDB = async (e) => {
        try {
            ...
            const res = await axios.post('https://final-project-sepia-sigma.vercel.app/addproduct', profileData,
                {
    ...
    const checkUnique = async () => {
        const res = await axios.get("https://final-project-sepia-sigma.vercel.app/product/serialNumber");
